Namespace My
    ...
    Partial Friend Class MyApplication
        ...
        Private Function ResolveAssemblies(sender As Object, e As System.ResolveEventArgs) As Reflection.Assembly
            ...
            If desiredAssembly.Name = "zxing" Then
                Return Reflection.Assembly.Load(My.Resources.zxing) 'replace with your assembly's resource name
            Else
                Return Nothing
            End If
            If desiredAssembly.Name = "zxing_presentation" Then
                Return Reflection.Assembly.Load(My.Resources.zxing_presentation) 'replace with your assembly's resource name
            Else
                Return Nothing
            End If
        End Function
